          ...
          <div className="container">
            ...
            >
              ...
              <div
                      ...
                      >
                        <Image className='red' style={{height:'auto', width:"100%" }} src={data!==null?data.branchImage:''}/>  
                      </div>
                      </SwiperSlide></Swiper>
                     <p>{data!==null && (data.branchImageDescriptionUz!==null || data.branchImageDescriptionRu!==null)?data.branchImageDescriptionUz!==null?data.branchImageDescriptionUz:data.branchImageDescriptionRudata.branchImageDescriptionRu!==null?data.branchImageDescriptionRu:data.branchImageDescriptionUz:''}</p>
                  </div>
