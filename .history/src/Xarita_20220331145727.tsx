...
import { coorA } from "./yandexmapKor";
...
const [region, setRegion] = useState<any>({})
  ...
  const [pol, setPol]=useState(coorA)


  const mapRef = React.createRef<any>(null);
    ...
    if (mapRef && mapRef.current) {
      ...
      ymaps.borders
        ...
        .then(function(result:any) {
          ...
          var regions = result.features.reduce(function(acc:any, feature) {
              ...
              {isNaN(user[0]) || isNaN(user[1]) ? (
               ...
               {/* <Clusterer
                ...
                >
                 ...
                 <GeoObject
                  style={{backgroundColor:'red', zIndex:345,}}
                geometry={{
                  type: "Polygon",
                  coordinates: coorA,
                  fillRule: 1,
