            ...
            >
              ...
              <SwiperSlide>
                <div
                  className="swiper-slide_body"
                  style={{
                    background: `url("https://vatanparvar.uz/Files/images/4"}) center center no-repeat`,
                    backgroundSize: "cover",
                  }}
                >
                  <div className="swiper-slide_bg" />
              ...
              <SwiperSlide>
                <div
                  className="swiper-slide_body"
                  style={{
                    background: `url("https://vatanparvar.uz/Files/images/5"}) center center no-repeat`,
                    backgroundSize: "cover",
                    backgroundPosition: "center",
                  }}
                >
              ...
              <SwiperSlide>
                <div
                  className="swiper-slide_body"
                  style={{
                    background: `url("https://vatanparvar.uz/Files/images/6"}) center center no-repeat`,
                    backgroundSize: "cover",
                  }}
                >
                  <div className="swiper-slide_bg" />
              ...
              <SwiperSlide>
                <div
                  className="swiper-slide_body"
                  style={{
                    background: `url("https://vatanparvar.uz/Files/images/7"}) center center no-repeat`,
                    backgroundSize: "cover",
                  }}
                >
                  <div className="swiper-slide_bg" />
              ...
              <SwiperSlide>
                <div
                  className="swiper-slide_body"
                  style={{
                    background: `url("https://vatanparvar.uz/Files/images/1"}) center center no-repeat`,
                    backgroundSize: "cover",
