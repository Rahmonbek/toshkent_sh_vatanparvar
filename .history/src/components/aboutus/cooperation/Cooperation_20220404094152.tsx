...
const Cooperation=()=> {
  ...
  useEffect(()=>{
    var id=Number(window.location.href.split("/")[window.location.href.split("/").length-1]
    ...
    .then((res) => {
      var a=[]
      a.push(res.data.filter((data1: any) => data1.branchId === id))
    setdata(a)
    console.log(a)
          ...
          <div className="container">
            ...
            >
              ...
              <div
                      ...
                      >
                        <Image className='red' style={{height:'auto', width:"100%" }} src={data!==null?data.image:''}/>  
                      </div>
                      </SwiperSlide></Swiper>
                     <p>{t('xamq')}</p>  
                     <p>{t('xamw')}</p>
