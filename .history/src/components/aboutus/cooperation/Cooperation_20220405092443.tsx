          ...
          <div className="container">
            ...
            >
              ...
              <div
                     ...
                     <p style={{textAlign:'justify', lineHeight:"2", fontSize:'18px', textIndent:'50px'}} dangerouslySetInnerHTML={{__html: t('lang') === 'uz' ? data.branchImageDescriptionUz : data.branchImageDescriptionRu}}>
                  </div>
