...
<br/><br/><br/><br/>
   ...
   <p className={style.narx}><b>{item.price===null?t("Bepul"):item.price+' s'}</b></p>
   <h1>{t("check")?item.nameUz!==null?item.nameUz:item.nameRu:item.nameRu!==null?item.nameRu:item.nameUz} toifaga tayyorlash</h1>
   <h3>3 oy</h3>
