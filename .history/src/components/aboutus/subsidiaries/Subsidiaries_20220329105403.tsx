          ...
          return(
            <div className="rahbariyat-list sal">
             ...
             <div className="content-wrapper">
              <Image  className="img" src={`${urlImg}/${item.photo}`} alt="img" />
              <div className="rahbariyat-list-text sug">
                ...
                {t('check')?item.branchPresidentUz:item.branchPresidentRu}
...
<Link className="butS" to="/tashkilot">{t("FILIAL HAQIDA")} <AiOutlineRight style={{position:'relative', top:"3px"}} size="1.2rem"/></Link>
              </div>
              </div>
              </div> 
            </div>
