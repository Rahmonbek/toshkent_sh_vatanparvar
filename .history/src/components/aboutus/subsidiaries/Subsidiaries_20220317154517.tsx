            ...
            <div className="rahbariyat-list">
             ...
             <div className="content-wrapper">
              ...
              <div className="rahbariyat-list-text sug">
                ...
                <div className="web" style={{height:'40px', display:'flex', alignItems:'center' marginTop:'-60px'}}>
<Link className="butS" to="/tashkilot">{t("Filial haqida")} <AiOutlineRight size="1.2rem"/></Link>
              </div>
              </div>
              </div> 
            </div>
