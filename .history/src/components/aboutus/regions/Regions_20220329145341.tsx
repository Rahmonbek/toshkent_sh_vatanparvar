        ...
        {data!==null?data.map((item:any, index:any)=>{
          return(
            <div className="rahbariyat-list">
             ...
             <div className="rahbariyat-list-text" style={{display:"flex", padding:'0px', alignItems:start', justifyContent:'center'}}> 
              ...
              <div className="rahbariyat-list-text">
                ...
                <div className="icons">
                  ...
                  <p  style={{position:'relative', top:'-14px'}}><a href="#">{item.email}</a></p>
                </div>
