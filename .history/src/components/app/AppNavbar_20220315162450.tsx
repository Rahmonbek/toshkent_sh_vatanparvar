                    ...
                    <ul className="app_nav-list">
                        <li className="app_nav-list_item with_sublist">
                            ...
                            <div className='chiz1'></div>
                                ...
                                <li className="app_nav-sub_list-item" onClick={closeNavbar}>
                                    <NavLink onClick={()=>{setFalse();setisbiz_haqimizda(true);setisActivetassarufidagi(true) }} className={isActivetassarufidagi?"active":''}  to="/tassarufidagi-tashkilotlar"><a className="app_nav-sub_list-link" href="#" dangerouslySetInnerHTML={{ __html: t("tassarufidagi_tashkilotlar") }}></a></NavLink>
                                </li>
                                {/* <li className="app_nav-sub_list-item" onClick={closeNavbar}>
