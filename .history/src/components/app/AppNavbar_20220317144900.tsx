...
<div className='chiz'></div>
                        ...
                        {/* <li className="app_nav-list_item" onClick={closeNavbar}>
                         ...
                         <li className="app_nav-list_item" onClick={closeNavbar}>
                                    <NavLink onClick={()=>{setFalse();setisbiz_haqimizda(true);setisActivetassarufidagi(true) }} className={isActivetassarufidagi?"active":''}  to="/filiallar"><a className="app_nav-sub_list-link" href="#" dangerouslySetInnerHTML={{ __html: t("tassarufidagi_tashkilotlar") }}></a></NavLink>
                                </li>
                        <li className="app_nav-list_item" onClick={closeNavbar}>
