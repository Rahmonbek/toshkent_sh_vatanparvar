...
import { regionI, regionII } from "../../host";
...
//  }]
  async function getContacts(){
    await http.get('GetApi/GetRegionIContacts')
    .then((res) => {
       var b=[]
       b.push(res.data.filter((data: any) => data.regionIId === regionI))
    ...
    //@ts-ignore
      ...
      a.push(res.data.filter((data: any) => data.regionIId === regionII))
      ...
      <PageTitle title={t("KONTAKTLAR")}/>
        ...
        <div className="sal">
                      ...
                      <Panel className={`${0===Number(number)?"Active":''} panel`}  style={{zIndex:-1}} key={0} header={
                              ...
                              <div style={{zIndex:-1}} className={style.headName}> {regionI.length!==0?t('check')?regionI[index - 1][0].regionIName:regionI[index - 1][0].regionINameRu:''}</div>
                             </div>}>
                             <Row>
<Col style={{padding:'10px'}} className="colAcc" md={12} sm={24}>
  <BsPerson size='1.3rem'  color="#133165" /><span className="salomText">{regionI.length!==0?t('check')?(regionI[index - 1][0].regionIPresident && regionI[index - 1][0].regionIPresident!==null?regionI[index - 1][0].regionIPresident:regionI[index - 1][0].regionIPresidentRu && regionI[index - 1][0].regionIPresidentRu!==null?regionI[index - 1][0].regionIPresidentRu:<span style={{color:'#a2a0a0'}}>{t("Ma'lumot mavjud emas")}</span>):regionI[index - 1][0].regionIPresidentRu && regionI[index - 1][0].regionIPresidentRu!==null?regionI[index - 1][0].regionIPresidentRu:regionI[index - 1][0].regionIPresident && regionI[index - 1][0].regionIPresident!==null?regionI[index - 1][0].regionIPresident:<span style={{color:'#a2a0a0'}}>{t("Ma'lumot mavjud emas")}</span>:''}</span>
  </Col>
  <Col style={{padding:'10px'}} className="colAcc" md={12} sm={24}>
  <AiOutlinePhone size='1.3rem'  color="#133165" /><span className="salomText">{regionI.length!==0?regionI[index - 1][0].phoneNumber===null?<span style={{color:'#a2a0a0'}}>{t("Ma'lumot mavjud emas")}</span>:regionI[index - 1][0].phoneNumber:''}</span>
  </Col>
  <Col style={{padding:'10px'}} className="colAcc" md={12} sm={24}>
  <HiOutlineMailOpen size='1.3rem'  color="#133165" /><span className="salomText">{regionI.length!==0?regionI[index - 1][0].email==="null"?<span style={{color:'#a2a0a0'}}>{t("Ma'lumot mavjud emas")}</span>:regionI[index - 1][0].email:''}</span>
  </Col>
  <Col className="colAcc" md={12} sm={24}>
<Tooltip placement="left" title={t("Bank nomi")}><RiBankFill  color="#133165" size='1.4rem' /> <span className="salomText">{regionI.length!==0?t('check')?(regionI[index - 1][0].bankName && regionI[index - 1][0].bankName!==null?regionI[index - 1][0].bankName:regionI[index - 1][0].bankNameRu && regionI[index - 1][0].bankNameRu!==null?regionI[index - 1][0].bankNameRu:<span style={{color:'#a2a0a0'}}>{t("Ma'lumot mavjud emas")}</span>):regionI[index - 1][0].bankNameRu && regionI[index - 1][0].bankNameRu!==null?regionI[index - 1][0].bankNameRu:regionI[index - 1][0].bankName && regionI[index - 1][0].bankName!==null?regionI[index - 1][0].bankName:<span style={{color:'#a2a0a0'}}>{t("Ma'lumot mavjud emas")}</span>:''}</span></Tooltip>
  </Col>
 
  
  <Col className="colAcc" md={12} sm={24}>
  <Tooltip placement="left" title={t("Tashkilot manzili")}><FaMapMarkerAlt  color="#133165" size='1.4rem' />  <span className="salomText">{regionI.length!==0?t('check')?(regionI[index - 1][0].regionIAdress && regionI[index - 1][0].regionIAdress!==null?regionI[index - 1][0].regionIAdress:regionI[index - 1][0].regionIAdressRu && regionI[index - 1][0].regionIAdressRu!==null?regionI[index - 1][0].regionIAdressRu:<span style={{color:'#a2a0a0'}}>{t("Ma'lumot mavjud emas")}</span>):regionI[index - 1][0].regionIAdressRu && regionI[index - 1][0].regionIAdressRu!==null?regionI[index - 1][0].regionIAdressRu:regionI[index - 1][0].regionIAdress && regionI[index - 1][0].regionIAdress!==null?regionI[index - 1][0].regionIAdress:<span style={{color:'#a2a0a0'}}>{t("Ma'lumot mavjud emas")}</span>:''}</span></Tooltip>
  </Col>
  <Col className="colAcc" md={12} sm={24}>
  <Tooltip placement="left" title={t("Tashkilot hisob raqami")}><RiBankCardFill  color="#133165" size='1.4rem' /> <span className="salomText">{regionI.length!==0?regionI.length!==0?regionI[index - 1][0].bankAccount===null?<span style={{color:'#a2a0a0'}}>{t("Ma'lumot mavjud emas")}</span>:regionI[index - 1][0].bankAccount.slice(0, 4)+" "+regionI[index - 1][0].bankAccount.slice(4, 8)+" "+regionI[index - 1][0].bankAccount.slice(8, 12)+" "+regionI[index - 1][0].bankAccount.slice(12, 16)+" "+regionI[index - 1][0].bankAccount.slice(16, 20):'':''}</span></Tooltip>
  </Col>
  <Col className="colAcc" md={12} sm={24}>
  <Tooltip placement="left" title={t("INN")}><b style={{color:'#133165'}}>INN</b> <span style={{top:'0px'}} className="salomText">{regionI.length!==0?regionI.length!==0?regionI[index - 1][0].inn===null?<span style={{color:'#a2a0a0'}}>{t("Ma'lumot mavjud emas")}</span>:regionI[index - 1][0].inn.slice(0, 3)+" "+regionI[index - 1][0].inn.slice(3, 6)+" "+regionI[index - 1][0].inn.slice(6, 9):'':''}</span></Tooltip>
  </Col>
 
  <Col className="colAcc" md={12} sm={24}>
  <Tooltip placement="left" title={t("MFO")}> <b style={{color:'#133165'}}>MFO</b> <span style={{top:'0px'}} className="salomText">{regionI.length!==0?regionI.length!==0?regionI[index - 1][0].bankMfo===null?<span style={{color:'#a2a0a0'}}>{t("Ma'lumot mavjud emas")}</span>:regionI[index - 1][0].bankMfo:'':''}</span></Tooltip>
  </Col>
  <Col className="colAcc" md={12} sm={24}>
  <Tooltip placement="left" title={t("Pochta indeks")}><BsFillEnvelopeFill color="#133165" size='1.4rem'/> <span className="salomText">{regionI.length!==0?regionI.length!==0?regionI[index - 1][0].mailIndex===null?<span style={{color:'#a2a0a0'}}>{t("Ma'lumot mavjud emas")}</span>:regionI[index - 1][0].mailIndex:'':''}</span></Tooltip>
  </Col>
...
<div className={style.op}>
                      ...
                      <Panel className={`${0===Number(number)?"Active":''} panel`}  style={{zIndex:-1}} key={0} header={
                              ...
                              <div style={{zIndex:-1}} className={style.headId}>{1}</div>
                              <div style={{zIndex:-1}} className={style.headName}> {regionI.length!==0?t('check')?regionI[index - 1][0].regionIName:regionI[index - 1][0].regionINameRu:''}</div>
                              <div style={{zIndex:-1}} className={style.headPerson}>{regionI.length!==0?t('check')?regionI[index - 1][0].regionIPresident:regionI[index - 1][0].regionIPresidentRu:''}</div>
                              <div style={{zIndex:-1}} className={style.headPhone}>{regionI.length!==0?regionI[index - 1][0].phoneNumber===null?"-":regionI[index - 1][0].phoneNumber:''}</div>
                              <div style={{zIndex:-1}} className={style.headEmail}>{regionI.length!==0?regionI[index - 1][0].email==="null"?"-":regionI[index - 1][0].email:''}</div>
                            </div>}>
                            <Row>
                            <Col className="colAcc" md={12} sm={24}>
<Tooltip placement="left" title={t("Bank nomi")}><RiBankFill  color="#133165" size='1.4rem' /> <span className="salomText">{regionI.length!==0?t('check')?(regionI[index - 1][0].bankName && regionI[index - 1][0].bankName!==null?regionI[index - 1][0].bankName:regionI[index - 1][0].bankNameRu && regionI[index - 1][0].bankNameRu!==null?regionI[index - 1][0].bankNameRu:<span style={{color:'#a2a0a0'}}>{t("Ma'lumot mavjud emas")}</span>):regionI[index - 1][0].bankNameRu && regionI[index - 1][0].bankNameRu!==null?regionI[index - 1][0].bankNameRu:regionI[index - 1][0].bankName && regionI[index - 1][0].bankName!==null?regionI[index - 1][0].bankName:<span style={{color:'#a2a0a0'}}>{t("Ma'lumot mavjud emas")}</span>:''}</span></Tooltip>
...
<Col className="colAcc" md={12} sm={24}>
  <Tooltip placement="left" title={t("Tashkilot hisob raqami")}><RiBankCardFill  color="#133165" size='1.4rem' /> <span className="salomText">{regionI.length!==0?regionI[index - 1][0].bankAccount===null?<span style={{color:'#a2a0a0'}}>{t("Ma'lumot mavjud emas")}</span>:regionI[index - 1][0].bankAccount.slice(0, 4)+" "+regionI[index - 1][0].bankAccount.slice(4, 8)+" "+regionI[index - 1][0].bankAccount.slice(8, 12)+" "+regionI[index - 1][0].bankAccount.slice(12, 16)+" "+regionI[index - 1][0].bankAccount.slice(16, 20):''}</span></Tooltip>
  </Col>
<Col className="colAcc" md={12} sm={24}>
  <Tooltip placement="left" title={t("INN")}><b style={{color:'#133165'}}>INN</b> <span style={{top:'0px'}} className="salomText">{regionI.length!==0?regionI[index - 1][0].inn===null?<span style={{color:'#a2a0a0'}}>{t("Ma'lumot mavjud emas")}</span>:regionI[index - 1][0].inn.slice(0, 3)+" "+regionI[index - 1][0].inn.slice(3, 6)+" "+regionI[index - 1][0].inn.slice(6, 9):''}</span></Tooltip>
  </Col>
<Col className="colAcc" md={12} sm={24}>
  <Tooltip placement="left" title={t("MFO")}> <b style={{color:'#133165'}}>MFO</b> <span style={{top:'0px'}} className="salomText">{regionI.length!==0?regionI[index - 1][0].bankMfo===null?<span style={{color:'#a2a0a0'}}>{t("Ma'lumot mavjud emas")}</span>:regionI[index - 1][0].bankMfo:''}</span></Tooltip>
  </Col>
<Col className="colAcc" md={12} sm={24}>
  <Tooltip placement="left" title={t("Pochta indeks")}><BsFillEnvelopeFill color="#133165" size='1.4rem'/> <span className="salomText">{regionI.length!==0?regionI[index - 1][0].mailIndex===null?<span style={{color:'#a2a0a0'}}>{t("Ma'lumot mavjud emas")}</span>:regionI[index - 1][0].mailIndex:''}</span></Tooltip>
  </Col>
