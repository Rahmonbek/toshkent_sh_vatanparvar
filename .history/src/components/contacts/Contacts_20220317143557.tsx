      ...
      <PageTitle title={t("KONTAKTLAR")}/>
        ...
        <div className="sal">
                      ...
                      <Panel className={`${0===Number(number)?"Active":''} panel`}  style={{zIndex:-1}} key={0} header={
                              ...
                              <div style={{zIndex:-1}} className="headId">{1}</div>
                              <div style={{zIndex:-1}} className="headName"><BsBuilding color="#133165"/>  {regionD.length!==0?t('check')?regionD[index - 1][0].regionName:regionD[index - 1][0].regionNameRu:''}</div>
                             </div>}>
                             <Row>
...
<Tooltip placement="left" title={t("Bank nomi")}><RiBankFill  color="#133165" size='1.4rem' /> <span className="salomText">{regionD.length!==0?t('check')?(regionD[index - 1][0].bankName && regionD[index - 1][0].bankName!==null?regionD[index - 1][0].bankName:regionD[index - 1][0].bankNameRu && regionD[index - 1][0].bankNameRu!==null?regionD[index - 1][0].bankNameRu:<span style={{color:'#a2a0a0'}}>{t("Ma'lumot mavjud emas")}</span>):regionD[index - 1][0].bankNameRu && regionD[index - 1][0].bankNameRu!==null?regionD[index - 1][0].bankNameRu:regionD[index - 1][0].bankName && regionD[index - 1][0].bankName!==null?regionD[index - 1][0].bankName:<span style={{color:'#a2a0a0'}}>{t("Ma'lumot mavjud emas")}</span>:''}</span></Tooltip>
  ...
  <Col className="colAcc" md={12} sm={24}>
  <Tooltip placement="left" title={t("Tashkilot manzili")}><FaMapMarkerAlt  color="#133165" size='1.4rem' />  <span className="salomText">{regionD.length!==0?t('check')?(regionD[index - 1][0].regionAdress && regionD[index - 1][0].regionAdress!==null?regionD[index - 1][0].regionAdress:regionD[index - 1][0].regionAdressRu && regionD[index - 1][0].regionAdressRu!==null?regionD[index - 1][0].regionAdressRu:<span style={{color:'#a2a0a0'}}>{t("Ma'lumot mavjud emas")}</span>):regionD[index - 1][0].regionAdressRu && regionD[index - 1][0].regionAdressRu!==null?regionD[index - 1][0].regionAdressRu:regionD[index - 1][0].regionAdress && regionD[index - 1][0].regionAdress!==null?regionD[index - 1][0].regionAdress:<span style={{color:'#a2a0a0'}}>{t("Ma'lumot mavjud emas")}</span>:''}</span></Tooltip>
  </Col>
  <Col className="colAcc" md={12} sm={24}>
...
<div className={style.op}>
                      ...
                      <Panel className={`${0===Number(number)?"Active":''} panel`}  style={{zIndex:-1}} key={0} header={
                              ...
                              <div style={{zIndex:-1}}  className={style.headName}> {regionD.length!==0?t('check')?regionD[index - 1][0].regionName:regionD[index - 1][0].regionNameRu:''}</div>
                              <div style={{zIndex:-1}} className={style.headPerson}>{regionD.length!==0?t('check')?regionD[index - 1][0].regionPresident:regionD[index - 1][0].regionPresidentRu:''}</div>
