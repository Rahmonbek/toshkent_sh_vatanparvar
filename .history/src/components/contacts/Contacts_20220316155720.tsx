...
<Tooltip placement="left" title={t("Bank nomi")}><RiBankFill  color="#133165" size='1.4rem' /></Tooltip> <span className="salomText">{item.bankName===null?<span style={{color:'#a2a0a0'}}>Ma'lumot mavjud emas</span>:item.bankName}</span>
  </Col>
 
  
  <Col className="colAcc" md={12} sm={24}>
  <Tooltip placement="left" title={t("Tashkilot manzili")}><FaMapMarkerAlt  color="#133165" size='1.4rem' />  </Tooltip><span className="salomText">{item.branchAdress===null?<span style={{color:'#a2a0a0'}}>Ma'lumot mavjud emas</span>:item.branchAdress}</span>
  </Col>
  <Col className="colAcc" md={12} sm={24}>
  <Tooltip placement="left" title={t("Tashkilot hisob raqami")}><RiBankCardFill  color="#133165" size='1.4rem' /> </Tooltip><span className="salomText">{item.bankAccount===null?<span style={{color:'#a2a0a0'}}>Ma'lumot mavjud emas</span>:item.bankAccount.slice(0, 4)+" "+item.bankAccount.slice(4, 8)+" "+item.bankAccount.slice(8, 12)+" "+item.bankAccount.slice(12, 16)+" "+item.bankAccount.slice(16, 20)} </span>
  </Col>
  <Col className="colAcc" md={12} sm={24}>
  <Tooltip placement="left" title={t("INN")}><b style={{color:'#133165'}}>INN</b> </Tooltip><span style={{top:'0px'}} className="salomText">{item.inn===null?<span style={{color:'#a2a0a0'}}>Ma'lumot mavjud emas</span>:item.inn.slice(0, 3)+" "+item.inn.slice(3, 6)+" "+item.inn.slice(6, 9)} </span>
  </Col>
 
  <Col className="colAcc" md={12} sm={24}>
  <Tooltip placement="left" title={t("MFO")}> <b style={{color:'#133165'}}>MFO</b> </Tooltip><span style={{top:'0px'}} className="salomText">{item.bankMfo===null?<span style={{color:'#a2a0a0'}}>Ma'lumot mavjud emas</span>:item.bankMfo} </span>
  </Col>
  <Col className="colAcc" md={12} sm={24}>
  <Tooltip placement="left" title={t("Pochta indeks")}><BsFillEnvelopeFill color="#133165" size='1.4rem'/> </Tooltip><span className="salomText">{item.mailIndex===null?<span style={{color:'#a2a0a0'}}>Ma'lumot mavjud emas</span>:item.mailIndex} </span>
  </Col>
