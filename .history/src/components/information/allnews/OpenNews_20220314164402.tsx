...
<div className="open-news-title">
            ...
            >
              ...
              <div
                      ...
                      >
                        <Image className='red' style={{height:'auto', width:"100%" }} src={`${(BASE_URL)+'/Files/News/'+(data.titleImage)}`}/>  
                      </div>
                      </SwiperSlide>
                  ...
                  {data.newsImage && data.newsImage.length!==0?data.newsImage.map((item: any, index: any)=>{
                      ...
                      >
                             <Image className='red' style={{height:'auto', width:"100%"}} src={`${(BASE_URL)+'/Files/News/'+(item.imageUrl)}`}/>  
                      </div>
                       </SwiperSlide>)
