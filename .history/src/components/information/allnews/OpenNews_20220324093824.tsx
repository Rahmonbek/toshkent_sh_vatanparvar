...
<div className="open-news-title">
            ...
            >
              ...
              <div
                      ...
                      >
                        <Image className='red' style={{height:'auto', width:"100%" }} src={`${data.regionId===null?urlV:url}/${data.tit}`}/>  
                      </div>
                      </SwiperSlide>
                  ...
                  {data.newsImage && data.newsImage.length!==0?data.newsImage.map((item: any, index: any)=>{
                      ...
                      >
                             <Image className='red' style={{height:'auto', width:"100%"}} src={`${(item.regionId===null?urlV:url)+"/"+(item.imageUrl)}`}/>  
                      </div>
                       </SwiperSlide>)
