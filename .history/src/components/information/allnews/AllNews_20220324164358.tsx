...
f.push(b[i])
    ...
    const indexOfLastPostUz = currentPage * postsPerPage;
    const indexOfFirstPostUz = indexOfLastPost - postsPerPage;

    const currentPostsUz = data.slice(indexOfFirstPost, indexOfLastPost);
