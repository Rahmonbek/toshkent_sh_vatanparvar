            ...
            <Swiper slidesPerView={1} spaceBetween={0}  autoplay={{
                ...
                <SwiperSlide>
                    <div className="swiper-slide_body" style={{
                        background: `url("https://vatanparvar.uz/static/media/photo1.3d440f961e272c53ccd8.jpg") center center no-repeat`,
                        backgroundSize: "cover"
                    }}>
                        <div className="swiper-slide_bg" />
                        <div className="swiper-slide_content">
                ...
                <SwiperSlide>
                    <div className="swiper-slide_body" style={{
                        background: `url("https://vatanparvar.uz/static/media/photo2.401c12df47e2437cd300.jpg&quot") center center no-repeat`,
                        backgroundSize: "cover"
                    }}>
                        <div className="swiper-slide_bg" />
                        <div className="swiper-slide_content">
