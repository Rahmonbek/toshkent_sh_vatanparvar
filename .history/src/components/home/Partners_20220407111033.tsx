                ...
                <Swiper  slidesPerView={1} spaceBetween={30}  autoplay={{
                       ...
                       <Tooltip placement="top" title="mudofaa.uz">
                        ...
                        <div className="swiper-slide_body">
                            <div className="slider-item_img">
                                <img src="https://vatanparvar.uz/static/media/mv.7cb7e3f93508b087d6a2.png" alt=""/>
                            </div>
                            <div>
                    ...
                    <SwiperSlide>
                       ...
                       <Tooltip placement="top" title="milliygvardiya.uz">
                        <div className="swiper-slide_body">
                            <div className="slider-item_img">
                                <img src="https://vatanparvar.uz/static/media/mg.20cc7d72ec1a6aa7ab91.png" alt=""/>
                            </div>
                            <div>
                    ...
                    <SwiperSlide>
                       ...
                       <Tooltip placement="top" title="iiv.uz">
                        <div className="swiper-slide_body">
                            <div className="slider-item_img">
                                <img src="https://vatanparvar.uz/static/media/iiv.22f92b71185f5160fdc4.png" alt=""/>
                            </div>
                            <div>
                    ...
                    <SwiperSlide>
                       ...
                       <Tooltip placement="top" title="yoshlar.gov.uz">
                        <div className="swiper-slide_body">
                            <div className="slider-item_img">
                                <img src="https://vatanparvar.uz/static/media/uzb1.111a88e033cf19b6eede.png" alt=""/>
                            </div>
                            <div>
