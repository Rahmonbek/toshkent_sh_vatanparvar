              ...
              <div className="location-container">
                <div className="location-info">
                    <div className="location-info-address">
                        <a href="https://maps.windows.com/?form=WNAMSH&collection=point.39.753049_64.414738_Point"  className='iconn'><HiOutlineLocationMarker className="icon" size="2.1rem" color="#133165" cursor="pointer"/></a>
                       <a href="https://maps.windows.com/?form=WNAMSH&collection=point.39.753049_64.414738_Point">{t("mk-address")} </a>  
                    </div>
