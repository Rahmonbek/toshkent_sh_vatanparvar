              ...
              <div className="location-container">
                <div className="location-info">
                    <div className="location-info-address">
                       ...
                       <a href="https://goo.gl/maps/WnKiD14WoYxDTAqL7"  target="_blank" >{data.length!==0?t("check")?data[0][0].regionAdress!==null?data[0][0].regionAdress:data[0][0].regionAdressRu:data[0][0].regionAdress!==null?data[0][0].regionAdress:data[0][0].regionAdressRu} </a>  
                    </div>
