...
<Form.Item label=" " data-placeholder={t("E-mail")} tooltip={{ title: t("Email manzilni to'g'ri kriitng"), icon:  <QuestionOutlined style={{color:'white'}} /> }}   className={`myFor in ${emailClass?"forPlace":''}`} name='email' rules={[{ required: true, type: 'email',  message: t("check")?`${t("E-mail")}${t("ni kirtishingiz shart")}`:`${t("ni kirtishingiz shart")} ${t("E-mail")}`}]}>
