...
<Form.Item  data-placeholder={t("Murojaat matni")} className={`myFor1 in ${textClass?"forPlace1":''}`} tooltip={{ title: t("Murajatni "), icon:  <QuestionOutlined style={{color:'white'}} /> }}   style={{width:'100%'}} >
