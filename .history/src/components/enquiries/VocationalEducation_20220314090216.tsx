...
<QuestionOutlined />  </Tooltip>
         ...
         <Select
           ...
           onChange={(value) => { form.setFieldsValue({districtId:null, branchId:null, categoryId:null}); setBranchdata(null);setSchooldata(null);  setDistrictL(value); setRegionsClass(true);  setCategoryClass(false); setSchoolClass(false); setDistrictClass(false); setDistrictL(true);handleDistrict(value);}}
